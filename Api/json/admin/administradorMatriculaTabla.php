<?php
    ...
    foreach ($rs_i as $row_i){
        ...
        $row_array['codigo'] = $row_i[1];
        $row_array['nombre'] = $row_i[2]." ".$row_i[3]." ".$row_i[4];
        $row_array['foto']   = $row_i[5];
        $row_array['aula']   = $row_i[6]." ".$row_i[7]." ".$row_i[8];
        $row_array['anio']   = $row_i[9];
        $row_array['estado'] = $row_i[10];
        $row_array['colegio'] = $row_i[11];
