...
<?php
    $row_i = gestorEstudiante::set_estudiante($_REQUEST['id']);
    $row_1 = gestorFicha::set_fichaEstudiante($row_i[0]);
    $row_2 = gestorGrado::set_grado($row_1[4]);
    $row_3 = gestorSeccion::set_seccion($row_1[5]);
    $row_4 = gestorNivel::set_nivel($row_1[6]);
?>
