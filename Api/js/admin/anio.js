var js_anio = function() {
    ...
    var DatatableJsonAnio = function() {
        var datatable = $('.m_regAnio').mDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: 'Api/json/admin/anioTabla.json.php'
                    },
                },
                pageSize: 10,
            },
    ...
    var handelAnioSubmit = function() {
        $('#btn-submit-new').click(function(e) {
            ...
            form.ajaxSubmit({
                type: 'POST',
                url: 'Api/core/module/admin/anioGestor.php',
                data: form.serialize(),
                dataType: 'json',
    ...
    var modalAnioNewSubmit = function() {
        ...
        $.post('view/modal/admin/administradorAnioNew.php', function(data) {
    ...
    var modalAnioUpdateSubmit = function(id) {
        ...
        $.post('view/modal/admin/administradorAnioUpdate.php', { id: id }, function(data) {
