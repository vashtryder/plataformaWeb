var js_periodo = function() {
    ...
    var DatatableJsonPeriodo = function(){
        var datatable = $('.m_regPeriodo').mDatatable({
                ...
                data: {
                    ...
                    source: {
                        read: {
                            url: 'view/module/administrador/administradorPeriodoTabla.php'
                        },
                    },
                    pageSize: 12,
                },
    ...
    var modalPeriodoNewSubmit = function(){
        ...
        $.post('view/module/administrador/administradorPeriodoNew.php',function(data){
    ...
    var modalPeriodoUpdateSubmit = function(id){
        ...
        $.post('view/module/administrador/administradorPeriodoUpdate.php',{id:id},function(data){
