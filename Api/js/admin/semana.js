var js_semana = function() {
    ...
    var DatatableJsonSemana = function(){
        var datatable = $('.m_regSemana').mDatatable({
                ...
                data: {
                    ...
                    source: {
                        read: {
                            url: 'view/module/administrador/administradorSemanaTabla.php'
                        },
                    },
                    pageSize: 12,
                },
    ...
    var modalSemanaNewSubmit = function(){
        ...
        $.post('view/module/administrador/administradorSemanaNew.php',function(data){
    ...
    var modalSemanaUpdateSubmit = function(id){
        ...
        $.post('view/module/administrador/administradorSemanaUpdate.php',{id:id},function(data){
