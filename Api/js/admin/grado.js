var js_grado = function() {
    ...
    var DatatableJsonGrado = function(){
        var datatable = $('.m_regGrado').mDatatable({
                ...
                data: {
                    ...
                    source: {
                        read: {
                            url: 'view/module/administrador/administradorGradoTabla.php'
                        },
                    },
                    pageSize: 12,
                },
    ...
    var modalGradoNewSubmit = function(){
        ...
        $.post('view/module/administrador/administradorGradoNew.php',function(data){
    ...
    var modalGradoUpdateSubmit = function(id){
        ...
        $.post('view/module/administrador/administradorGradoUpdate.php',{id:id},function(data){
