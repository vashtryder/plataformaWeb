var js_pregunta = function() {
    ...
    var DatatableJsonPregunta = function(){
        var datatable = $('.m_regPregunta').mDatatable({
                ...
                data: {
                    ...
                    source: {
                        read: {
                            url: 'view/module/administrador/administradorPreguntaTabla.php'
                        },
                    },
                    pageSize: 12,
                },
    ...
    var modalPreguntaNewSubmit = function(){
        ...
        $.post('view/module/administrador/administradorPreguntaNew.php',function(data){
    ...
    var modalPreguntaUpdateSubmit = function(id){
        ...
        $.post('view/module/administrador/administradorPreguntaUpdate.php',{id:id},function(data){
