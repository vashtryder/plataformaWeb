var js_proceso = function() {
    ...
    var DatatableJsonProceso = function() {
        var datatable = $('.m_regProceso').mDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: 'Api/json/admin/procesoTabla.json.php'
                    },
                },
                pageSize: 30,
                serverSorting: false
    ...
    var modalProcesoNewSubmit = function() {
        ...
        $.post('view/modal/admin/administradorProcesoNew.php', function(data) {
    ...
    var modalProcesoUpdateSubmit = function(id) {
        ...
        $.post('view/modal/admin/administradorProcesoUpdate.php', { id: id }, function(data) {
