var js_asignacion = function() {
    ...
    var DatatableJsonAsignacion = function(){
        var datatable = $('.m_regAsignacion').mDatatable({
                ...
                data: {
                    ...
                    source: {
                        read: {
                            url: 'view/module/administrador/administradorAsignacionTabla.php'
                        },
                    },
                    pageSize: 12,
                },
    ...
    var modalAsignacionNewSubmit = function(){
        ...
        $.post('view/module/director/direccionAsignacionNew.php',function(data){
    ...
    var modalAsignacionUpdateSubmit = function(id){
        ...
        $.post('view/module/director/direccionAsignacionUpdate.php',{id:id},function(data){
