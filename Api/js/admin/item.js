var js_item = function() {
    ...
    var DatatableJsonItem = function(){
        var datatable = $('.m_regItem').mDatatable({
                translate: {
                    records: {
                        processing: 'Cargando...',
                ...
                data: {
                    ...
                    source: {
                        read: {
                            url: 'view/module/administrador/administradorItemTabla.php'
                        },
                    },
                    pageSize: 12,
                },
                ...
                columns: [{
                    ...
                    template: function (row, index, datatable) {
                        return '\<a onclick="js_item.modalItemUpdateSubmit('+ row.id +')" class="btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Actualizar">\
                                    <i class="fa fa-edit"></i>\
                                </a>\
                                <a onclick="js_item.modalItemDeleteSubmit('+ row.id +')" class="btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Eliminar">\
        ...
        $('#btn-submit-new').click(function(e){
            ...
            form.validate({
                ...
                messages: { // custom messages for radio buttons and checkboxes
                    ...
                    proceso:{
                        required: "Por favor, Seleccione Proceso."
                    }
                },
            ...
            $('.select2Proceso').on('change', function () {
                $(this).valid();
            });
    ...
    var modalItemNewSubmit = function(){
        $('#m_modalAgregar').modal('show');
        $.post('view/module/administrador/administradorItemNew.php',function(data){
            $('#m_modalNew').html(data);
        })
    }

    var modalItemUpdateSubmit = function(id){
        $('#m_modalActualizar').modal('show');
        $.post('view/module/administrador/administradorItemUpdate.php',{id:id},function(data){
    ...
    var modalItemDeleteSubmit = function(id){
        bootbox.dialog({
    ...
    return{
        ...
        modalItemNewSubmit: function(){
            modalItemNewSubmit()
        },
        modalItemUpdateSubmit: function(id){
            modalItemUpdateSubmit(id)
        },
        modalItemDeleteSubmit: function(id){
            modalItemDeleteSubmit(id)
        }
