var js_area = function() {
    ...
    var DatatableJsonArea = function(){
        var datatable = $('.m_regArea').mDatatable({
                ...
                data: {
                    ...
                    source: {
                        read: {
                            url: 'view/module/administrador/administradorAreaTabla.php'
                        },
                    },
                    pageSize: 12,
                },
    ...
    var modalAreaNewSubmit = function(){
        ...
        $.post('view/module/administrador/administradorAreaNew.php',function(data){
    ...
    var modalAreaUpdateSubmit = function(id){
        ...
        $.post('view/module/administrador/administradorAreaUpdate.php',{id:id},function(data){
