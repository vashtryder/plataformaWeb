var js_nivel = function() {
    ...
    var DatatableJsonNivel = function() {
        var datatable = $('.m_regNivel').mDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: 'Api/json/admin/nivelTabla.json.php'
                    },
                },
                pageSize: 10,
            },
    ...
    var handelNivelSubmit = function() {
        $('#btn-submit-new').click(function(e) {
            ...
            form.ajaxSubmit({
                type: 'POST',
                url: 'Api/core/module/admin/nivelGestor.php',
                data: form.serialize(),
                dataType: 'json',
    ...
    var modalNivelNewSubmit = function() {
        ...
        $.post('view/modal/admin/administradorNivelNew.php', function(data) {
    ...
    var modalNivelUpdateSubmit = function(id) {
        ...
        $.post('view/modal/admin/administradorNivelUpdate.php', { id: id }, function(data) {
