var js_curso = function() {
    ...
    var DatatableJsonCurso = function(){
        var datatable = $('.m_regCurso').mDatatable({
                ...
                data: {
                    ...
                    source: {
                        read: {
                            url: 'view/module/administrador/administradorCursoTabla.php'
                        },
                    },
                    pageSize: 12,
                },
    ...
    var modalCursoNewSubmit = function(){
        ...
        $.post('view/module/administrador/administradorCursoNew.php',function(data){
    ...
    var modalCursoUpdateSubmit = function(id){
        ...
        $.post('view/module/administrador/administradorCursoUpdate.php',{id:id},function(data){
