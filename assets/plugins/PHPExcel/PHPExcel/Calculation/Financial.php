...
class PHPExcel_Calculation_Financial {
	 ...
	 * This function is provided for the French accounting system. If an assetssssssss is purchased in
	 * the middle of the accounting period, the prorated depreciation is taken into account.
	 * The function is similar to AMORLINC, except that a depreciation coefficient is applied in
	 * the calculation depending on the life of the <?php print_r(ROOT_FRAMEWORK) ?>/assetssssssssss.
	 * This function will return the depreciation until the last period of the life of the <?php print_r(ROOT_FRAMEWORK) ?>/assetssssssssss
	 * or until the cumulated value of depreciation is greater than the cost of the <?php print_r(ROOT_FRAMEWORK) ?>/assetssssssssss minus
	 * the salvage value.
	 *
	 * Excel Function:
	 ...
	 * @access	public
	 * @category Financial Functions
	 * @param	float	cost		The cost of the assetssssssss.
	 * @param	mixed	purchased	Date of the purchase of the assetssssssss.
	 * @param	mixed	firstPeriod	Date of the end of the first period.
	 * @param	mixed	salvage		The salvage value at the end of the life of the assetssssssss.
	...
	public static function AMORDEGRC($cost, $purchased, $firstPeriod, $salvage, $period, $rate, $basis=0) {
		...
		//	Life of <?php print_r(ROOT_FRAMEWORK) ?>/assetssssssssss (1/rate)		Depreciation coefficient
		//	Less than 3 years			1
	 ...
	 * DB
	 *
	 * Returns the depreciation of an assetssssssss for a specified period using the
	 ...
	 * @access	public
	 * @category Financial Functions
	 * @param	float	cost		Initial cost of the assetssssssss.
	 * @param	float	salvage		Value at the end of the depreciation.
	 *								(Sometimes called the salvage value of the assetssssssss)
	 * @param	integer	life		Number of periods over which the assetssssssss is depreciated.
	 *								(Sometimes called the useful life of the assetssssssss)
	 ...
	 * SLN
	 *
	 * Returns the straight-line depreciation of an assetssssssss for one period
	 *
	 * @param	cost		Initial cost of the assetssssssss
	 * @param	salvage		Value at the end of the depreciation
	 * @param	life		Number of periods over which the assetssssssss is depreciated
	 * @return	float
	 */
	 ...
	 * SYD
	 *
	 * Returns the sum-of-years' digits depreciation of an assetssssssss for a specified period.
	 *
	 * @param	cost		Initial cost of the assetssssssss
	 * @param	salvage		Value at the end of the depreciation
	 * @param	life		Number of periods over which the assetssssssss is depreciated
