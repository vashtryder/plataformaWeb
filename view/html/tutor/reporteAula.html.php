                    ...
                    <div class="row m-row--full-height">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-8">
                            <div class="m-portlet m-portlet--border-bottom-success m-portlet--rounded">
                                ...
                                <!--begin::Form-->
                                <form id="m-reporteAula" class="m-form">
                                    ...
                                    <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                                        <div class="m-form__actions m-form__actions--solid">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <button id="btn-submit-aula1" type="button" class="btn btn-outline-primary">PDF</button>
                                                </div>
                                                <div class="col-lg-6 m--align-right">
                                                    <button id="btn-submit-aula2" type="button" class="btn btn-outline-danger">EXCEL</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
