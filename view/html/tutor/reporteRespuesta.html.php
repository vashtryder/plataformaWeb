                                    ...
                                    <div class="m-portlet__head-caption">
                                        <div class="m-portlet__head-title">
                                            ...
                                            <h3 class="m-portlet__head-text">
                                                REPORTE CUADRO PORCENTUAL DE RESPUESTAS
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form id="m-reporteRespuesta" class="m-form m-form--fit m-form--label-align-right">
                                    ...
                                    <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                                        <div class="m-form__actions m-form__actions--solid">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <button id="btn-submit-respuesta1" type="reset" class="btn btn-outline-primary">PDF</button>
                                                </div>
                                                <div class="col-lg-6 m--align-right">
                                                    <button id="btn-submit-respuesta2" type="reset" class="btn btn-outline-danger">EXCEL</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
