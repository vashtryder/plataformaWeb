									...
									<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
										...
										<li class="m-menu__item <?php if($_REQUEST['s'] == 'administradorDocente' || $_REQUEST['s'] == 'administradorMatricula' || $_REQUEST['s'] == 'administradorImportarEstudiante' || $_REQUEST['s'] == 'administradorImportarDocente') print_r('m-menu__item--active') ?>  m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" aria-haspopup="true">
											...
											<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
												<span class="m-menu__arrow m-menu__arrow--adjust"></span>
												<ul class="m-menu__subnav">
													<li class="m-menu__item <?php if($_REQUEST['s'] == 'administradorMatricula') echo 'm-menu__item--active' ?>" aria-haspopup="true">
													...
													<li class="m-menu__item <?php if($_REQUEST['s'] == 'administradorDocente') echo 'm-menu__item--active' ?>" aria-haspopup="true">
						...
						<div id="m_header_topbar" class="m-topbar  m-stack m-stack--ver m-stack--general">
							<div class="m-stack__item m-topbar__nav-wrapper">
								<ul class="m-topbar__nav m-nav m-nav--inline">
									<li class=" m-nav__item m-nav__item--focus m-dropdown m-dropdown--large m-dropdown--arrow m-dropdown--align-center m-dropdown--mobile-full-width m-dropdown--skin-light	m-list-search m-list-search--skin-light" m-dropdown-toggle="click" m-dropdown-persistent="1" id="m_quicksearch" m-quicksearch-mode="dropdown">
												...
												<div class="m-dropdown__header">
													<form class="m-list-search__form">
														<div class="m-list-search__form-wrapper">
															...
															<span class="m-list-search__form-icon-close" id="m_quicksearch_close"><i class="la la-remove"></i></span>
														</div>
													</form>
												</div>
										...
										<div class="m-dropdown__wrapper">
											...
											<div class="m-dropdown__inner">
												<div class="m-dropdown__header m--align-center">
													<span class="m-dropdown__header-title">Tienes 9</span>
													<span class="m-dropdown__header-subtitle">Mensajes</span>
												</div>
												<div class="m-dropdown__body">
													<div class="m-dropdown__content">
															...
															<div class="tab-pane active" id="topbar_notifications_notifications" role="tabpanel">
																<div class="m-scrollable" data-scrollable="true" data-height="250" data-mobile-height="200">
																	<div class="m-list-timeline m-list-timeline--skin-light">
																		...
																		<?php //$rsn = ::set_mensaje_recibido(array($_SESSION['colegio'][0],$_SESSION['user'][0])) ?>
									...
									<li class="m-nav__item m-dropdown m-dropdown--medium m-dropdown--arrow  m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" m-dropdown-toggle="click">
										<a href="#" class="m-nav__link m-dropdown__toggle">
											<span class="m-topbar__username m--hidden-mobile .m-name">Hola, <?php Sistema::imprimir($_SESSION["user"][4]) ?></span>
												...
												<div class="m-dropdown__header m--align-center">
													<div class="m-card-user m-card-user--skin-light">
														...
														<div class="m-card-user__details">
															<span class="m-card-user__name m--font-weight-500 m-nameuser"><?php sistema::imprimir($_SESSION["user"][2]." ".$_SESSION["user"][3]) ?> <br> <?php sistema::imprimir($_SESSION["user"][4]) ?></span>
														...
														<ul class="m-nav m-nav--skin-light">
															...
															<li class="m-nav__item">
																<a href="#" onclick="js_profile.modaleMessageUpdateSubmit(1)"  class="m-nav__link">
																	...
																	<span class="m-nav__link-title">  
																		<span class="m-nav__link-wrap">      
																			<span class="m-nav__link-text">Mis Mensajes</span>
