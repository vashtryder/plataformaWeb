										...
										<div class="m-portlet__head-caption">
											<div class="m-portlet__head-title">
												...
												<h3 class="m-portlet__head-text">
													LISTA DE MATRICULADOS <?php sistema::imprimir($_SESSION['anio'][1]) ?>
												</h3>
											</div>
										</div>
									</div>
									...
									<div class="m-portlet__body">
										...
										<div class="row align-items-center">
											...
											<div class="col-xl-4 order-1 order-xl-2 m--align-right">
												<a href="#" onclick="js_estudiante.modalEstudianteNewSubmit()" class="btn btn-focus m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
...
<div class="modal fade" id="m_modalAgregar"  role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form class="m-form m-form--state m-form--label-align-right m-form--group-seperator-dashed">
        <div class="modal-body">
            <div id="m_modalNew"></div>
        </div>
      <div class="modal-footer">
        <button id="btn-submit-new" type="button" class="btn btn-outline-primary">Matricular</button>
...
<div class="modal fade" id="m-modalFoto"  role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">ACTUALIZAR FOTOGRAFIA</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <form id="from-foto" class="m-form m-form--label-align-right">
      <div class="modal-body">
        <div id="m_Avatar"></div>
      </div>
      <div class="modal-footer">
        <button id="btn-submit-foto" type="button" class="btn btn-outline-primary">Actualizar</button>
        <button id="btn-cancel-foto" type="button" class="btn btn-outline-metal" data-dismiss="modal">Cancelar</button>
      </div>
    </form>
    </div>
  </div>
