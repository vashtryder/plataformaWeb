									...
									<div class="m-portlet__body">
										...
										<div class="row align-items-center">
											...
											<div class="col-xl-4 order-1 order-xl-2 m--align-right">
												<a href="#" onclick="js_grado.modalGradoNewSubmit()" class="btn btn-focus m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
													<span>Agregar</span>
												</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">CREAR GRADO</h5>
...
<div class="modal fade" id="m_modalActualizar"  role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="m-formm-form--state m-form--label-align-right">
      <div class="modal-body">
