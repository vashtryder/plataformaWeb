									...
									<div class="m-portlet__body">
										...
										<div class="row align-items-center">
											...
											<div class="col-xl-4 order-1 order-xl-2 m--align-right">
												<a href="#" onclick="js_area.modalAreaNewSubmit()" class="btn btn-focus m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
													<span>Agregar</span>
												</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">CREAR AREÁ ACADEMICA</h5>
...
<div class="modal fade" id="m_modalActualizar"  role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">ACTUALIZAR ÁREA ACADÉMICA</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
